...
```
Install-Package Naxam.StatusBarCompat.Android
```

## Usage

Plz follow the official guide [here](https://github.com/niorgai/StatusBarCompat).

## License

Stripe binding library for iOS is released under the MIT license.
...
Follow us for the latest updates<br>[![Twitter URL](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)](https://twitter.com/intent/tweet?text=https://github.com/naxam/stripe-ios-binding)
